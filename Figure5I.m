...
%% Lateral VTA - Figure 5I 
regionStim = 'M, Inj latVTA, Fiber latVTA, CueOff Inhibition';
...
mID_opto = {
       ...
       'c11_m34n';       
       'c11_m35n';   
       %'c11_m37n';   % m37n_00: doesn't have analysis file
       'c11_m39n';        
       };
...
save('lVTA_opto_tones_11hz','lVTA_opto_tones_11hz')
save('lVTA_yfp_tones_11hz','lVTA_opto_tones_11hz')
...
save('lVTA_opto_tones_1s','lVTA_opto_tones_1s')
save('lVTA_yfp_tones_1s','lVTA_opto_tones_1s')

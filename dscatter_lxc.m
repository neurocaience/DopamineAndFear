function [hAxes, F, Y, H, G, bin, edges1, edges2] = dscatter_lxc(X,Y, varargin)
% dscatter() is written by Robert Henson: https://www.mathworks.com/matlabcentral/fileexchange/8430-flow-cytometry-data-reader-and-visualization?focused=6779476&tab=function
% dscatter_lxc() is a modified version of dscatter by Lili X. Cai 2/26/2020
...
H = accumarray(bin,1,nbins([2 1])) ./ n; %% lxcai

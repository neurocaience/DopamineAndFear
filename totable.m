...
[frz_or, frz_om, frz_ostd, frz_yr, frz_ym, frz_ystd] = frz_eval(d_opto,d_yfp,0,19,tones, 21);   % for CS
[frz_or5, frz_om5, frz_ostd5, frz_yr5, frz_ym5, frz_ystd5] = frz_eval(d_opto,d_yfp,0,6,tones, 21);   % for CS first 5 seconds
[frz_or1, frz_om1, frz_ostd1, frz_yr1, frz_ym1, frz_ystd1] = frz_eval(d_opto,d_yfp,20,25,tones, 21);  % 'light'  
[frz_or2, frz_om2, frz_ostd2, frz_yr2, frz_ym2, frz_ystd2] = frz_eval(d_opto,d_yfp,26,31,tones, 21);  % 'postlight' original: 26-31 or 26-45
[frz_or3, frz_om3, frz_ostd3, frz_yr3, frz_ym3, frz_ystd3] = frz_eval(d_opto,d_yfp,20,39,tones, 21);   % 'immediate iti' original: 32-45
[frz_or4, frz_om4, frz_ostd4, frz_yr4, frz_ym4, frz_ystd4] = frz_eval(d_opto,d_yfp,20,39,tones, 21);   % 'iti_20s'  20 s post light 
...
% Create table 
tabl1 = table(X1, mID, roi, group, extD, tN, ttN, frz_cs, frz_light, frz_postlight6s, frz_iti, frz_cs5, frz_pre, ...
    'VariableNames', {'ones','mID','roi','group','extD','tN','ttN','f_cs','f_light','f_postlight','f_iti','f_cs5', 'f_pre'});

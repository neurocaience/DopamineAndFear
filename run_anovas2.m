function [SSQs, DFs, MSQs, Fs, Ps, name, tbl_anova] = run_anovas2(tbl)
...
name = {'f_cs','f_light','f_postlight','f_iti','f_cs5','f_pre', 'f_postlightiti', 'f_31_60'};

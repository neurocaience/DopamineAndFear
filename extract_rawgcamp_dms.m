function [master_gcamp, master_gcamp_tones] = extract_rawgcamp_dms(mID, ttlchannel, ttlsign)
...
for m = 1:size(mID,1)
    ...
    for expd = 0:3
        ...
        temp_gcamp2 = polyfit_gcamp_dF_F(temp_gcamp,ttlchannel(m),ttlsign(m),mID{m},expd+1);   % For all latVTA animals, TTLsign and chanel = 2 (might not be for mVTA animals)
